...
/**
 * Factory for a record-operations search action.
 *
 * Forwards the query to the optional consumer; the operations surface can
 * apply local filtering when a persisted query state is not used.
 */
