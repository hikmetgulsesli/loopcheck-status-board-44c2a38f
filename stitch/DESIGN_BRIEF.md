...
- Record Operations - LoopCheck Status Board
- Record Editor - LoopCheck Status Board
- Status Board - LoopCheck Status Board
- Insights - LoopCheck Status Board

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - LoopCheck Status Board
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - LoopCheck Status Board
...
SCREEN_SPEC_3:
- exact_screen_title: Status Board - LoopCheck Status Board
...
- purpose: Help users organize Record work by status, priority, readiness, and handoff state when those signals are part of the requested product.
...
SCREEN_SPEC_4:
- exact_screen_title: Insights - LoopCheck Status Board
